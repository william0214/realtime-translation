...
- [x] 設計密碼輸入對話框 UI
- [x] 實施密碼驗證邏輯（前端）
- [x] 將密碼儲存在 localStorage（已驗證狀態，24 小時有效）
- [x] 修改預設目標語言為英文
- [ ] 測試密碼保護功能
- [ ] 測試預設語言顯示

### 實施詳情
- [x] Home.tsx: 加入密碼對話框 UI
- [x] Home.tsx: 實施 handlePasswordSubmit 函數
- [x] Home.tsx: 將預設語言從 "vi" 改為 "en"
- [x] Settings.tsx: 加入驗證檢查，未驗證者自動跳轉回首頁
- [x] 密碼：translateAdm88
- [x] 驗證有效期：24 小時
- [x] TypeScript 編譯無錯誤
